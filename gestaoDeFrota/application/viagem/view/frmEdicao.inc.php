<?php
    ...
    $sql = "SELECT vi.via_km_inicial, vi.via_km_final, vi.via_observacoes, vi.via_gastos, age.age_hora_ini, cid.cid_nome, usu.usu_nome, vei.vei_nome FROM viagem vi
            ...
            <form role="form" action="?module=viagem&acao=grava_viagem" id="MyForm" method="post" enctype="multipart/form-data" name="MyForm">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="number" class="form-control" disabled readonly value="<?php echo $result[0]['via_km_inicial'] ?>"/>
                    </div>

                    <div class="col-sm-2">
                        <label class="control-label" for="via_km_final">KM Final do carro:</label>
                        <input type="number" class="form-control" disabled readonly value="<?php echo $result[0]['via_km_final'] ?>"/>
                    </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-12">
                        ...
                        <textarea name="via_gastos" class="form-control" disabled readonly><?php echo $result[0]['via_gastos'] ?></textarea>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-12">
                        ...
                        <textarea name="via_observacoes" class="form-control" disabled readonly><?php echo $result[0]['via_observacoes'] ?></textarea>
                    </div>
                </div>
