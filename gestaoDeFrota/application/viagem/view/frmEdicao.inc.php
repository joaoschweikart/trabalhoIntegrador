            ...
            <form role="form" action="?module=viagem&acao=grava_viagem" id="MyForm" method="post" enctype="multipart/form-data" name="MyForm">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="text" class="form-control" disabled readonly value="<?php echo $result[0]['via_km_inicial'] ?>"/>
                    </div>

                    <div class="col-sm-2">
                        <label class="control-label" for="via_km_final">KM Final do carro:</label>
                        <input type="text" class="form-control" disabled readonly value="<?php echo $result[0]['via_km_final'] ?>"/>
                    </div>
