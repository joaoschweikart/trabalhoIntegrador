...
switch ($_GET['acao']) {
  ...
  case 'grava_usuario':
    if($_POST['set_cod']){
      ...
      $aux2['usu_cod']  = $_SESSION['gestaoVeiculos_userId'];
  ...
  case 'update_usuario':
    ...
    if($_SESSION['gestaoVeiculos_userId'] == $_POST['usu_cod']){
      $_SESSION['gestaoVeiculos_userName'] = mb_strtoupper($_POST['usu_nome'], 'UTF-8');
    }
