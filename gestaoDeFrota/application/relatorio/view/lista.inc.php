...
<form role="form" action="application/relatorio/view/atividade/relatorio.php " target="_blank" id="MyForm" method="post" > 
    ...
    <input type="hidden" value="<?php echo $_SESSION['gestaoVeiculos_userPermissao']?>" name="permissao"/>
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="row form-group">  
                    <?php if($_SESSION['gestaoVeiculos_userPermissao'] == 1){ ?>
                        <div class="col-sm-4" >     
                        ...
                        <?php }else{ ?>
                            <input type="hidden" name="usu_cod" value="<?php echo $_SESSION['gestaoVeiculos_userId']?>">
                        <?php }?>    
                    <div class="col-sm-4" > 
